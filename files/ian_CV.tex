...
\begin{enumerate}
    \item Michael A. Kouritzin, \textbf{Ian Zhang}$^\dag$, Jyoti Bhadana, Seoyeon Park \hfill \textit{2026}\\
...
\begin{enumerate}
    ...
    \item Hanlong Chen*, \textbf{Ian Zhang}*, Bruna Seixas-Lima, Howard Chertkow, $\ldots$, Malcolm Binns \hfill \textit{2026}\\
