...
\begin{document}
\sloppy
\hfill {\scriptsize\textit{\textcolor{gray}{Last updated: April 2026}}}
\begin{center}
...
\begin{itemize}[itemsep=2pt, parsep=0pt, topsep=0pt]
    \item \underline{Advisors:} Joshua Speagle, Thibault Randrianarisoa
\end{itemize}
\vspace{0.5em}
\textbf{MSc in Statistics}, University of Toronto \hfill \textit{Sep 2025 - Jun 2026}
\begin{itemize}[itemsep=2pt, parsep=0pt, topsep=0pt]
    \item \underline{Advisor:} Nancy Reid
...
\begin{enumerate}
    \item Aditya Khan, \textbf{Ian Zhang} \hfill \textit{2025}\\
    ...
    \item \textbf{Ian Zhang}, Thibault Randrianarisoa \hfill \textit{2026}\\
...
Will be presenting \textit{Likelihood tempering to mitigate prior dominance in variational
