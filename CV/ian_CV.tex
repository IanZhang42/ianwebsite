...
\begin{document}
\hfill {\scriptsize\textit{\textcolor{gray}{Last updated: August 2026}}}
\begin{center}
...
\begin{enumerate}
    ...
    \item Gabriel Liu$^*$, \textbf{Ian Zhang}$^{*,\dag}$, \ldots, Daniel Alessi \hfill \textit{2026}\\
    LiBRE: Statistical Learning for Representative Brine Design and
    Lithium Enrichment Analysis
\end{enumerate}

\section*{Research Experience}
\textbf{Doctoral Student}, Department of Statistical Sciences/University of Toronto \hfill \textit{2026-Present}
\vspace{0.5em}
...
\subsubsection*{2025-2026 School Year}
...
\subsubsection*{2026-2027 School Year}
\textbf{MAT148: Calculus I with Proofs} \hfill \textit{Fall 2026}\\
\textbf{STA257: Probability and Statistics I} \hfill\textit{Fall 2026}\\
\textbf{MAT149: Calculus II with Proofs} \hfill\textit{Winter 2027}\\
\textbf{STA457: Time Series Analysis} \hfill \textit{Winter 2027}
